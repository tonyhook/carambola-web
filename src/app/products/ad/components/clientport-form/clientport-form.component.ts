...
import { AntiFraud, AntiFraudAPI, AntiFraudPeriod, Client, ClientAPI, ClientMedia, ClientMediaAPI, ClientPort, ClientPortAPI, Connection, PartnerType, PortType, TrafficControl, TrafficControlAPI, TrafficControlIndicator, TrafficControlPeriod } from '../..';
import { TenantService } from '../..';
import { ConnectionComponent, FilteredSelectClientComponent, FilteredSelectClientMediaComponent } from '../..';
...
export class ClientPortFormComponent implements AfterViewInit {
  ...
  config: QueryBuilderConfig = {
    fields: {
      ...
      'id#513#2025': {name: 'ID类型: caid（iOS 14+，广协）2025版', type: 'string'},
