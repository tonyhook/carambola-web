...
import { PartnerType, ROLE_TENANT_DOWNSTREAM_MANAGER_DIRECT, ROLE_TENANT_DOWNSTREAM_MANAGER_PROGRAMMATIC, TenantAPI, TenantUser, Vendor, VendorAPI } from '../..';
...
export class VendorFormComponent {
  ...
  readonly inputDownstream = viewChild<ElementRef<HTMLInputElement>>('inputDownstream');
