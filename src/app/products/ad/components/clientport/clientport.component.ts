...
import { AdQuery } from '../..';
import { Client, ClientAPI, ClientMedia, ClientMediaAPI, ClientPort, ClientPortAPI, PartnerType, PortType } from '../..';
...
export class ClientPortManagerComponent implements OnInit, AfterViewInit {
  ...
  dataRequest$ = new Subject<AdQuery<ClientPort>>();
