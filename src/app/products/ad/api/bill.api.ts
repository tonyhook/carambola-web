...
import { Bill, Medium, PerformancePlaceholder, Sign, AdQuery, Upload } from '../../../products/ad';
...
export class BillAPI {
  ...
  getBillList(interval: string, start: string, end: string, query?: AdQuery<PerformancePlaceholder>): Observable<Bill[]> {
  ...
  downloadBill(interval: string, aggregateUpstream: string, start: string, end: string, query?: AdQuery<PerformancePlaceholder>): Observable<Blob> {
    let params = new HttpParams()
      .set('interval', interval)
  ...
  getMediumListClient(interval: string, start: string, end: string, query?: AdQuery<PerformancePlaceholder>): Observable<Medium[]> {
    let params = new HttpParams()
      .set('interval', interval)
      .set('start', start)
      .set('end', end);
  ...
  getMediumListVendor(interval: string, start: string, end: string, query?: AdQuery<PerformancePlaceholder>): Observable<Medium[]> {
    let params = new HttpParams()
      .set('interval', interval)
      .set('start', start)
      .set('end', end);
  ...
  getSignList(interval: string, start: string, end: string, query?: AdQuery<PerformancePlaceholder>): Observable<Sign[]> {
    let params = new HttpParams()
      .set('interval', interval)
      .set('start', start)
      .set('end', end);
  ...
  downloadSign(interval: string, aggregateDownstream: string, start: string, end: string, query?: AdQuery<PerformancePlaceholder>): Observable<Blob> {
    let params = new HttpParams()
      .set('interval', interval)
  ...
  downloadSummary(interval: string, aggregateUpstream: string, aggregateDownstream: string, start: string, end: string, queryUpstream?: AdQuery<PerformancePlaceholder>, queryDownstream?: AdQuery<PerformancePlaceholder>): Observable<Blob> {
    let params = new HttpParams()
      .set('interval', interval)
      .set('aggregateUpstream', aggregateUpstream)
      .set('aggregateDownstream', aggregateDownstream)
