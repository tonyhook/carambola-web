...
import { VendorMedia } from '../..';
import { AdEntityComponent } from '../ad-entity/ad-entity.component';

type FilteredSelectVendorMediaValue = VendorMedia | VendorMedia[] | null;
type FilteredSelectVendorMediaFormGroup = FormGroup<{
  selection: FormControl<FilteredSelectVendorMediaValue>;
...
export class FilteredSelectVendorMediaComponent implements OnDestroy, AfterViewInit, ControlValueAccessor, MatFormFieldControl<VendorMedia | VendorMedia[]> {
  ...
  readonly filteredCandidates = signal<VendorMedia[]>([]);
  oldFilter = '';
  ...
  formGroup: FilteredSelectVendorMediaFormGroup;
  ...
  constructor() {
    ...
    this.formGroup = this.formBuilder.group({
      selection: this.formBuilder.control<FilteredSelectVendorMediaValue>(this.multiple() ? [] : null, this.required ? Validators.required : []),
